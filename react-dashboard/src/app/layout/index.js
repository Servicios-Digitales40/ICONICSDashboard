/**
 * app/layout/index.js — el armazón visual de la aplicación.
 *
 * Sidebar y Topbar no son componentes reutilizables: hay exactamente uno de
 * cada uno, montado por `App.jsx`, y ambos leen la configuración de rutas.
 * Por eso viven en `app/` y no en `components/`.
 */
