...
/*
 * `conFuenteEva` es obligatorio: da acceso al proveedor de datos de Demo EVA.
 * Sin él `useSistemaAgua` no tiene de dónde leer. Mismo patrón que las otras
 * vistas de la carpeta.
 */
export default conFuenteEva(RiesgosEva);
