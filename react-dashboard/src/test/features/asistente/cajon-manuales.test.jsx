...
/**
 * cajon-manuales.test.jsx
 * ------------------------------------------------------------------
 * El cajón «Manuales» (`features/asistente/cajones/Manuales.jsx`, Plan 16
 * Fase 1/2), montado de verdad sobre un `fetch` de mentira que contesta lo
 * que cada prueba necesita — no tiene dominio de planta detrás, así que no
 * hay origen simulado que aprovechar.
 *
 * Se monta el COMPONENTE, no una ruta: en esta rama no hay rutas (Plan 20
 * §2.12). Cubre la capacidad 7 del encargo —anexar manuales desde la UI—, que
 * es el único camino por el que entra conocimiento externo al asistente.
 *
