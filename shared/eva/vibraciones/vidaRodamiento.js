 ...
 * @param {number} [geometria.Z]      número de elementos rodantes
 * @param {number} [geometria.Bd]     diámetro del elemento rodante
 * @param {number} [geometria.Pd]     diámetro primitivo (paso)
 * @param {number} [geometria.alpha]  ángulo de contacto, en grados
 */
 ...
 *
 * @param {object} [datos]
 * @param {number} [datos.C]    capacidad de carga dinámica, en newtons
 * @param {number} [datos.P]    carga equivalente sobre el rodamiento, en newtons
 * @param {number} [datos.rpm]  velocidad de giro
 * @param {number} [datos.p]    exponente de la ley de vida (3 para bolas)
 */
 ...
 * @param {number} [datos.P]                carga equivalente sobre el rodamiento, en newtons
 * @param {number} [datos.rpm]               velocidad de giro
 * @param {number} [datos.horasAcumuladas]  horas de marcha ya acumuladas
 * @param {number} [datos.p]                 exponente de la ley de vida (3 para bolas)
 */
 ...
 *
 * @param {object} [datos]
 * @param {number} [datos.d]       calibre (diámetro interior) del rodamiento, en mm
 * @param {number} [datos.rpm]     velocidad de giro
 * @param {number} [datos.factor]  factor de condiciones (K)
 */
