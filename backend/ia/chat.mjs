...
function instrucciones(catalogo, maxPasos) {
  return [
    ...
    'primero (grafico_de_senal y analisis_de_senal sólo admiten 7 días, y un reporte puede pedir',
    'más). El argumento "explicacion" es sólo para cuando YA conoces la tendencia de la señal',
