...
export function instrucciones(catalogo, maxPasos, idioma = 'es', foco = null, contexto = null) {
  return [
    ...
    'Si nombran un TIPO de reporte —técnico, de vibraciones/CMS, de lectura de sensores, de riesgos,',
    'de alarmas, de ingeniería, de energías, de predicciones— pásalo en "tipo"; si sólo dicen "un',
    'reporte", omite "tipo". La respuesta trae qué secciones salieron con dato y cuáles sin él, con su',
    'motivo: dilo tal cual, no describas secciones que no están en esa lista.',
